...
var _excluded = ["type", "displayType", "customInput", "renderText", "getInputRef", "format", "thousandSeparator", "decimalSeparator", "allowedDecimalSeparators", "thousandsGroupStyle", "decimalScale", "fixedDecimalScale", "prefix", "suffix", "removeFormatting", "mask", "defaultValue", "isNumericString", "allowNegative", "allowEmptyFormatting", "allowLeadingZeros", "onValueChange", "isAllowed", "customNumerals", "onChange", "onKeyDown", "onMouseUp", "onFocus", "onBlur", "value"];
  ...
  _createClass(NumberFormat, [{
    ...
    value: function render() {
      ...
      var _this$props13 = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props13, _excluded);
      ...
      if (displayType === 'text') {
        return renderText ? renderText(value, otherProps) || null : /*#__PURE__*/_react["default"].createElement("span", _extends({}, otherProps, {
          ref: getInputRef
        }), value);
      } else if (customInput) {
